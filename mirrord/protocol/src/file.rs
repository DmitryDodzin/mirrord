...
use crate::fast_versioned;

fast_versioned!(
    #[doc = "Internal version of Metadata across operating system (macOS, Linux)"]
    #[doc = "Only mutual attributes"]
    #[derive(
        Encode, Decode, Debug, PartialEq, Clone, Copy, Eq, Default, Serialize, Deserialize,
    )]
