...
impl RemoteError {
    ...
    // .protocol.std_types.SocketAddr InvalidAddress = 3;

    pub fn InvalidAddress(&self) -> &super::std_types::SocketAddr {
        match self.remoteErrorType {
            ::std::option::Option::Some(remote_error::RemoteErrorType::InvalidAddress(ref v)) => v,
            _ => <super::std_types::SocketAddr as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_InvalidAddress(&mut self, v: super::std_types::SocketAddr) {
        self.remoteErrorType = ::std::option::Option::Some(remote_error::RemoteErrorType::InvalidAddress(v))
    }

    // Mutable pointer to the field.
    pub fn mut_InvalidAddress(&mut self) -> &mut super::std_types::SocketAddr {
        if let ::std::option::Option::Some(remote_error::RemoteErrorType::InvalidAddress(_)) = self.remoteErrorType {
        } else {
            self.remoteErrorType = ::std::option::Option::Some(remote_error::RemoteErrorType::InvalidAddress(super::std_types::SocketAddr::new()));
        }
        match self.remoteErrorType {
    ...
    // Take field
    pub fn take_InvalidAddress(&mut self) -> super::std_types::SocketAddr {
        if self.has_InvalidAddress() {
            ...
            super::std_types::SocketAddr::new()
        }
    }

    // .protocol.std_types.SocketAddr connect_timed_out = 4;

    pub fn connect_timed_out(&self) -> &super::std_types::SocketAddr {
        match self.remoteErrorType {
    ...
    // Param is passed by value, moved
    pub fn set_connect_timed_out(&mut self, v: super::std_types::SocketAddr) {
        self.remoteErrorType = ::std::option::Option::Some(remote_error::RemoteErrorType::ConnectTimedOut(v))
    }

    // Mutable pointer to the field.
    pub fn mut_connect_timed_out(&mut self) -> &mut super::std_types::SocketAddr {
        if let ::std::option::Option::Some(remote_error::RemoteErrorType::ConnectTimedOut(_)) = self.remoteErrorType {
        } else {
            self.remoteErrorType = ::std::option::Option::Some(remote_error::RemoteErrorType::ConnectTimedOut(super::std_types::SocketAddr::new()));
        }
        match self.remoteErrorType {
    ...
    // Take field
    pub fn take_connect_timed_out(&mut self) -> super::std_types::SocketAddr {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, super::std_types::SocketAddr>(
            "InvalidAddress",
...
pub mod remote_error {
    ...
    pub enum RemoteErrorType {
        ...
        InvalidAddress(super::super::std_types::SocketAddr),
        // @@protoc_insertion_point(oneof_field:protocol.error.RemoteError.connect_timed_out)
        ConnectTimedOut(super::super::std_types::SocketAddr),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0berror.proto\x12\x0eprotocol.error\x1a\x0fstd_types.proto\"~\n\x11E\
    rrorKindInternal\x12-\n\x04kind\x18\x01\x20\x01(\x0e2\x19.protocol.error\
    .ErrorKindR\x04kind\x12(\n\runknown_value\x18\x02\x20\x01(\tH\0R\x0cunkn\
    ownValue\x88\x01\x01B\x10\n\x0e_unknown_value\"\xd6\x03\n\rResponseError\
    \x12/\n\x12allocation_failure\x18\x01\x20\x01(\tH\0R\x11allocationFailur\
    e\x12\x1d\n\tnot_found\x18\x02\x20\x01(\x04H\0R\x08notFound\x12%\n\rnot_\
    directory\x18\x03\x20\x01(\x04H\0R\x0cnotDirectory\x12\x1b\n\x08not_file\
    \x18\x04\x20\x01(\x04H\0R\x07notFile\x12<\n\tremote_io\x18\x05\x20\x01(\
    \x0b2\x1d.protocol.error.RemoteIOErrorH\0R\x08remoteIo\x12?\n\ndns_looku\
    p\x18\x06\x20\x01(\x0b2\x1e.protocol.error.DnsLookupErrorH\0R\tdnsLookup\
    \x12@\n\x0cremote_error\x18\x07\x20\x01(\x0b2\x1b.protocol.error.RemoteE\
    rrorH\0R\x0bremoteError\x120\n\x13port_already_stolen\x18\x08\x20\x01(\
    \x05H\0R\x11portAlreadyStolen\x12)\n\x0fnot_implemented\x18\t\x20\x01(\
    \x08H\0R\x0enotImplementedB\x13\n\x11responseErrorType\"~\n\rRemoteIOErr\
    or\x12%\n\x0craw_os_error\x18\x01\x20\x01(\x05H\0R\nrawOsError\x88\x01\
    \x01\x125\n\x04kind\x18\x02\x20\x01(\x0b2!.protocol.error.ErrorKindInter\
    nalR\x04kindB\x0f\n\r_raw_os_error\"G\n\x0eDnsLookupError\x125\n\x04kind\
    \x18\x01\x20\x01(\x0b2!.protocol.error.ErrorKindInternalR\x04kind\"K\n\
    \x17BadHttpFilterRegexError\x12\x16\n\x06filter\x18\x01\x20\x01(\tR\x06f\
    ilter\x12\x18\n\x07message\x18\x02\x20\x01(\tR\x07message\"\xf5\x02\n\
    \x0bRemoteError\x122\n\x14nameserver_not_found\x18\x01\x20\x01(\x08H\0R\
    \x12nameserverNotFound\x12)\n\x0faddress_parsing\x18\x02\x20\x01(\tH\0R\
    \x0eaddressParsing\x12H\n\x0eInvalidAddress\x18\x03\x20\x01(\x0b2\x1e.pr\
    otocol.std_types.SocketAddrH\0R\x0eInvalidAddress\x12L\n\x11connect_time\
    d_out\x18\x04\x20\x01(\x0b2\x1e.protocol.std_types.SocketAddrH\0R\x0fcon\
    nectTimedOut\x12\\\n\x15bad_http_filter_regex\x18\x05\x20\x01(\x0b2'.pro\
    tocol.error.BadHttpFilterRegexErrorH\0R\x12badHttpFilterRegexB\x11\n\x0f\
    remoteErrorType*\x99\x06\n\tErrorKind\x12\x0c\n\x08NotFound\x10\0\x12\
    \x14\n\x10PermissionDenied\x10\x01\x12\x15\n\x11ConnectionRefused\x10\
    \x02\x12\x13\n\x0fConnectionReset\x10\x03\x12\x13\n\x0fHostUnreachable\
    \x10\x04\x12\x16\n\x12NetworkUnreachable\x10\x05\x12\x15\n\x11Connection\
    Aborted\x10\x06\x12\x10\n\x0cNotConnected\x10\x07\x12\r\n\tAddrInUse\x10\
    \x08\x12\x14\n\x10AddrNotAvailable\x10\t\x12\x0f\n\x0bNetworkDown\x10\n\
    \x12\x0e\n\nBrokenPipe\x10\x0b\x12\x11\n\rAlreadyExists\x10\x0c\x12\x0e\
    \n\nWouldBlock\x10\r\x12\x11\n\rNotADirectory\x10\x0e\x12\x10\n\x0cIsADi\
    rectory\x10\x10\x12\x15\n\x11DirectoryNotEmpty\x10\x11\x12\x16\n\x12Read\
    OnlyFilesystem\x10\x12\x12\x12\n\x0eFilesystemLoop\x10\x13\x12\x1a\n\x16\
    StaleNetworkFileHandle\x10\x14\x12\x10\n\x0cInvalidInput\x10\x15\x12\x0f\
    \n\x0bInvalidData\x10\x16\x12\x0c\n\x08TimedOut\x10\x17\x12\r\n\tWriteZe\
    ro\x10\x18\x12\x0f\n\x0bStorageFull\x10\x19\x12\x0f\n\x0bNotSeekable\x10\
    \x1a\x12\x1b\n\x17FilesystemQuotaExceeded\x10\x1b\x12\x10\n\x0cFileTooLa\
    rge\x10\x1c\x12\x10\n\x0cResourceBusy\x10\x1d\x12\x16\n\x12ExecutableFil\
    eBusy\x10\x1e\x12\x0c\n\x08Deadlock\x10\x1f\x12\x12\n\x0eCrossesDevices\
    \x10\x20\x12\x10\n\x0cTooManyLinks\x10!\x12\x13\n\x0fInvalidFilename\x10\
    \"\x12\x17\n\x13ArgumentListTooLong\x10#\x12\x0f\n\x0bInterrupted\x10$\
    \x12\x0f\n\x0bUnsupported\x10%\x12\x11\n\rUnexpectedEof\x10&\x12\x0f\n\
    \x0bOutOfMemory\x10'\x12\t\n\x05Other\x10(\x12\x0b\n\x07Unknown\x10)J\
    \xb7\x18\n\x06\x12\x04\0\0[\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\
    \x01\x02\x12\x03\x02\0\x17\n\t\n\x02\x03\0\x12\x03\x04\0\x19\n\n\n\x02\
    \x05\0\x12\x04\x06\00\x01\n\n\n\x03\x05\0\x01\x12\x03\x06\x05\x0e\n\x0b\
    \n\x04\x05\0\x02\0\x12\x03\x07\x08\x15\n\x0c\n\x05\x05\0\x02\0\x01\x12\
    \x03\x07\x08\x10\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x07\x13\x14\n\x0b\n\
    \x04\x05\0\x02\x01\x12\x03\x08\x04\x19\n\x0c\n\x05\x05\0\x02\x01\x01\x12\
    ...
    \n\x04\x05\0\x02\x07\x12\x03\x0e\x04\x15\n\x0c\n\x05\x05\0\x02\x07\x01\
    \x12\x03\x0e\x04\x10\n\x0c\n\x05\x05\0\x02\x07\x02\x12\x03\x0e\x13\x14\n\
    \x0b\n\x04\x05\0\x02\x08\x12\x03\x0f\x04\x12\n\x0c\n\x05\x05\0\x02\x08\
    ...
    \x0b\n\x04\x05\0\x02\x0b\x12\x03\x12\x04\x14\n\x0c\n\x05\x05\0\x02\x0b\
    \x01\x12\x03\x12\x04\x0e\n\x0c\n\x05\x05\0\x02\x0b\x02\x12\x03\x12\x11\
    \x13\n\x0b\n\x04\x05\0\x02\x0c\x12\x03\x13\x04\x17\n\x0c\n\x05\x05\0\x02\
    \x0c\x01\x12\x03\x13\x04\x11\n\x0c\n\x05\x05\0\x02\x0c\x02\x12\x03\x13\
n\x0c\n\x05\x04\0\x02\x01\x01\x12\x034\x18%\n\x0c\
    \n\x05\x04\0\x02\x01\x03\x12\x034()\n\n\n\x02\x04\x01\x12\x047\0C\x01\n\
    \n\n\x03\x04\x01\x01\x12\x037\x08\x15\n\x0c\n\x04\x04\x01\x08\0\x12\x048\
    \x08B\t\n\x0c\n\x05\x04\x01\x08\0\x01\x12\x038\x0e\x1f\n\x0b\n\x04\x04\
    \x01\x02\0\x12\x039\x10.\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x039\x10\x16\
    \n\x0c\n\x05\x04\x01\x02\0\x01\x12\x039\x17)\n\x0c\n\x05\x04\x01\x02\0\
    \x03\x12\x039,-\n\x0b\n\x04\x04\x01\x02\x01\x12\x03:\x10%\n\x0c\n\x05\
    \x04\x01\x02\x01\x05\x12\x03:\x10\x16\n\x0c\n\x05\x04\x01\x02\x01\x01\
    \x12\x03:\x17\x20\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03:#$\n\x0b\n\x04\
    \x04\x01\x02\x02\x12\x03;\x10)\n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03;\
    \x10\x16\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03;\x17$\n\x0c\n\x05\x04\
    \x01\x02\x02\x03\x12\x03;'(\n\x0b\n\x04\x04\x01\x02\x03\x12\x03<\x10$\n\
    \x0c\n\x05\x04\x01\x02\x03\x05\x12\x03<\x10\x16\n\x0c\n\x05\x04\x01\x02\
    ...
    \x10.\n\x0c\n\x05\x04\x01\x02\x05\x06\x12\x03>\x10\x1e\n\x0c\n\x05\x04\
    \x01\x02\x05\x01\x12\x03>\x1f)\n\x0c\n\x05\x04\x01\x02\x05\x03\x12\x03>,\
    -\n\x0b\n\x04\x04\x01\x02\x06\x12\x03?\x10-\n\x0c\n\x05\x04\x01\x02\x06\
    \x06\x12\x03?\x10\x1b\n\x0c\n\x05\x04\x01\x02\x06\x01\x12\x03?\x1c(\n\
    \x0c\n\x05\x04\x01\x02\x06\x03\x12\x03?+,\n\x0b\n\x04\x04\x01\x02\x07\
    \x12\x03@\x10.\n\x0c\n\x05\x04\x01\x02\x07\x05\x12\x03@\x10\x15\n\x0c\n\
    \x05\x04\x01\x02\x07\x01\x12\x03@\x16)\n\x0c\n\x05\x04\x01\x02\x07\x03\
    \x12\x03@,-\n\x0b\n\x04\x04\x01\x02\x08\x12\x03A\x10)\n\x0c\n\x05\x04\
    \x01\x02\x08\x05\x12\x03A\x10\x14\n\x0c\n\x05\x04\x01\x02\x08\x01\x12\
    \x03A\x15$\n\x0c\n\x05\x04\x01\x02\x08\x03\x12\x03A'(\n\n\n\x02\x04\x02\
    \x12\x04E\0H\x01\n\n\n\x03\x04\x02\x01\x12\x03E\x08\x15\n\x0b\n\x04\x04\
    \x02\x02\0\x12\x03F\x08(\n\x0c\n\x05\x04\x02\x02\0\x04\x12\x03F\x08\x10\
    \n\x0c\n\x05\x04\x02\x02\0\x05\x12\x