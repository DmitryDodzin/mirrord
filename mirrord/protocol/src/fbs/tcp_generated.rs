...
impl<'a> NewTcpConnection<'a> {
  ...
  pub const VT_DESTINATION_PORT: flatbuffers::VOffsetT = 8;
  pub const VT_SOURCE_PORT: flatbuffers::VOffsetT = 10;
  pub const VT_LOCAL_ADDRESS: flatbuffers::VOffsetT = 12;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.local_address { builder.add_local_address(x); }
    if let Some(x) = args.remote_address { builder.add_remote_address(x); }
    builder.add_source_port(args.source_port);
    builder.add_destination_port(args.destination_port);
    builder.finish()
  }
  ...
  pub fn connection_id(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(NewTcpConnection::VT_CONNECTION_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn remote_address(&self) -> Option<&'a IpAddr> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<IpAddr>(NewTcpConnection::VT_REMOTE_ADDRESS, None)}
  }
  #[inline]
  pub fn destination_port(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(NewTcpConnection::VT_DESTINATION_PORT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn source_port(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(NewTcpConnection::VT_SOURCE_PORT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn local_address(&self) -> Option<&'a IpAddr> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<IpAddr>(NewTcpConnection::VT_LOCAL_ADDRESS, None)}
  }
}
...
impl flatbuffers::Verifiable for NewTcpConnection<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u16>("destination_port", Self::VT_DESTINATION_PORT, false)?
...
impl<'a: 'b, 'b> NewTcpConnectionBuilder<'a, 'b> {
  ...
  pub fn add_connection_id(&mut self, connection_id: u64) {
    self.fbb_.push_slot::<u64>(NewTcpConnection::VT_CONNECTION_ID, connection_id, 0);
  }
  #[inline]
  pub fn add_remote_address(&mut self, remote_address: &IpAddr) {
    self.fbb_.push_slot_always::<&IpAddr>(NewTcpConnection::VT_REMOTE_ADDRESS, remote_address);
  }
  #[inline]
  pub fn add_destination_port(&mut self, destination_port: u16) {
    self.fbb_.push_slot::<u16>(NewTcpConnection::VT_DESTINATION_PORT, destination_port, 0);
  }
  #[inline]
  pub fn add_source_port(&mut self, source_port: u16) {
    self.fbb_.push_slot::<u16>(NewTcpConnection::VT_SOURCE_PORT, source_port, 0);
  }
  #[inline]
  pub fn add_local_address(&mut self, local_address: &IpAddr) {
    self.fbb_.push_slot_always::<&IpAddr>(NewTcpConnection::VT_LOCAL_ADDRESS, local_address);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> NewTcpConnectionBuilder<'a, 'b> {
...
impl core::fmt::Debug for NewTcpConnection<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("NewTcpConnection");
      ...
      ds.field("destination_port", &self.destination_port());
...
impl<'a> TcpData<'a> {
  ...
  pub fn connection_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(TcpData::VT_CONNECTION_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn bytes(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(TcpData::VT_BYTES, None)}
  }
}
...
impl<'a: 'b, 'b> TcpDataBuilder<'a, 'b> {
  #[inline]
  pub fn add_connection_id(&mut self, connection_id: u64) {
    self.fbb_.push_slot::<u64>(TcpData::VT_CONNECTION_ID, connection_id, 0);
  }
  #[inline]
  pub fn add_bytes(&mut self, bytes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TcpData::VT_BYTES, bytes);
  }
  #[inline]
...
impl<'a> DaemonTcp<'a> {
  ...
  pub fn inner_type(&self) -> DaemonTcpMessage {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<DaemonTcpMessage>(DaemonTcp::VT_INNER_TYPE, Some(DaemonTcpMessage::NONE)).unwrap()}
  }
  #[inline]
  pub fn inner(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(DaemonTcp::VT_INNER, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for DaemonTcp<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<DaemonTcpMessage, _>("inner_type", Self::VT_INNER_TYPE, "inner", Self::VT_INNER, false, |key, v, pos| {
        match key {
          DaemonTcpMessage::NewTcpConnection => v.verify_union_variant::<flatbuffers::ForwardsUOffset<NewTcpConnection>>("DaemonTcpMessage::NewTcpConnection", pos),
          DaemonTcpMessage::TcpData => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TcpData>>("DaemonTcpMessage::TcpData", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> DaemonTcpBuilder<'a, 'b> {
  ...
  pub fn add_inner_type(&mut self, inner_type: DaemonTcpMessage) {
    self.fbb_.push_slot::<DaemonTcpMessage>(DaemonTcp::VT_INNER_TYPE, inner_type, DaemonTcpMessage::NONE);
  }
  #[inline]
  pub fn add_inner(&mut self, inner: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DaemonTcp::VT_INNER, inner);
  }
  #[inline]
...
pub fn size_prefixed_root_as_daemon_tcp(buf: &[u8]) -> Result<DaemonTcp, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed DaemonTcp and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_daemon_tcp_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<DaemonTcp<'a>>) {
